             ...
             <div class="accordion" id="accordionExample">
                 <div class="card">
                     <div class="card-header badge badge-primary" id="headingOne">
                         <h5 class="text-dark">Tambah Jenis Barang</h5>
                         ...
                         <div class="card-body">
                             <form method="POST" action="">
                                 <div class="form-group row">
                                     ...
                                     <div class="col-sm-10">
                                         <input type="text" class="form-control" id="name" name="name" placeholder="Jenis Barang" value="<?= set_value('name'); ?>">
                             ...
                             <?php
                                ...
                                foreach ($jenis as $b) { ?>
                                 <tr>
                                     ...
                                     <td><?= $b->jenis ?></td>
                                     <td>
                                         <a href="" data-jenis="<?= $b->id ?>" class="badge badge-warning edit-jenis" data-toggle="modal" data-target="#edit_jenis"><i class="dripicons-document-edit"></i> Edit</a>
                                         <a href="<?= base_url('pegawai/jenis_del/' . $b->id) ?>" class="badge badge-danger" onclick="return confirm('Yakin Hapus?')"><i class="dripicons-trash"></i> Hapus</a>
                                     </td>
                                 </tr>
                             <?php } ?>
                         </tbody>
         ...
         <div class="modal-dialog modal-dialog-centered" role="document">
             <div class="modal-content">
                 <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLongTitle">Edit Jenis</h5>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                         <span aria-hidden="true">&times;</span>
                     </button>
                 </div>
                 <div class="modal-body">
                     <form method="POST" action="<?= base_url('pegawai/jenis_update/') ?>">
                         <div class="form-group row">
                             <input type="hidden" name="id" id="id">
                             <label for="example-text-input" class="col-sm-2 col-form-label">Jenis</label>
                             <div class="col-sm-10">
                                 <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Nama Jenis">
