                             ...
                             <?php
                                ...
                                foreach ($keluar as $b) { ?>
                                 <tr>
                                     ...
                                     <td><?= $b->pegawai ?></td>
                                     <td>
                                         <a href="<?= base_url('pegawai/barang_keluar_edt/') . $b->kd_keluar ?>" class="badge badge-warning"><i class="fas fa-edit"></i> Edit</a>
                 ...
                 <div class="modal-body">
                     <form method="POST" action="">
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-sm-8">
                                 <input name="tgl" id="tanggal" class="form-control datepicker" placeholder="Tanggal Keluar" type="text" required>
                             </div>
                         </div>
                         <div class="form-group row">
